...
import ImportacionPreciosIvecoForm from "./importacion-precios-iveco-form";

export default function ConsultarImportacionPreciosIveco() {
      ...
      <main className="relative container mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="w-full">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">Importación de Productos IVECO</h1>
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Gestiona y actualiza los productos IVECO de manera eficiente
            </p>
          </div>
          ...
          {isModalOpen && (
            <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
              <div className="relative w-full max-w-2xl animate-in fade-in-0 zoom-in-95 duration-300">
                <ImportacionPreciosIvecoForm onClose={closeModal} onSuccess={() => {}} />
              </div>
            </div>
          )}
        </div>
