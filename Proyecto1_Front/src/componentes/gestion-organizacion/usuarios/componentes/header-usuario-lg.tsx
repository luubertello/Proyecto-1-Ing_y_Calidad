...
interface HeaderUsuarioLgProps {
...
export const HeaderUsuarioLg = ({
  ...
  paginaActual,
  openModal,
}: HeaderUsuarioLgProps) => {
  return (
    <CardHeader className="items-center p-3 space-y-2">
      {/* Primera fila: Título y botón agregar */}
      <div className="flex items-center justify-between">
        <CardTitle className="flex items-center space-x-2">
          <DollarSign className="consultar-icon w-5 h-5 sm:w-6 sm:h-6" />
          <span className="text-base sm:text-xl font-semibold">Usuarios</span>
        </CardTitle>
